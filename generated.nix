...
}:
{
  ...
  desktop = buildGrammar {
    ...
    language = "desktop";
    version = "0.0.0+rev=317de59070dd4f8bd0af03dd3dea5dda0e7a0449";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
  ...
  editorconfig = buildGrammar {
    ...
    version = "0.0.0+rev=3d4994215125087ffea228ccec3654d313968579";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
  ...
  lua = buildGrammar {
    passthru.name = "lua";
    language = "lua";
    version = "0.0.0+rev=97db86785105b198a760c82f146e4b52d889f386";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  v = buildGrammar {
    passthru.name = "v";
    language = "v";
    version = "0.0.0+rev=5f6c9c414f6e1ca3b991830c2d32b4cb83bef383";
    src = fetchFromGitHub {
      owner = "vlang";
      repo = "v-analyzer";
  ...
  xresources = buildGrammar {
    ...
    language = "xresources";
    version = "0.0.0+rev=ff2b89e99d7760e77544b662125df84d7be1641d";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
