...
}:
{
  ...
  c3 = buildGrammar {
    passthru.name = "c3";
    language = "c3";
    version = "0.0.0+rev=6b4e9127f90fa35d39f5314211bc5f7e304304bb";
    src = fetchFromGitHub {
      owner = "c3lang";
      repo = "tree-sitter-c3";
  ...
  desktop = buildGrammar {
    ...
    language = "desktop";
    version = "0.0.0+rev=c38aed8c230dd8f59b5f74ffa5046352b3d376e2";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
  ...
  editorconfig = buildGrammar {
    ...
    version = "0.0.0+rev=c571889b7c875690b78f79c4304cbf267e130818";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
  ...
  mlir = buildGrammar {
    passthru.name = "mlir";
    language = "mlir";
    version = "0.0.0+rev=6b15a0164c0aeed3009e9feff3dc38d54e91cef9";
    src = fetchFromGitHub {
      owner = "artagnon";
  ...
  strace = buildGrammar {
    ...
    language = "strace";
    version = "0.0.0+rev=776e96ca962a58cd6858e2c5a2dd4e7e941dbcd4";
    src = fetchFromGitHub {
      owner = "sigmaSd";
  ...
  typoscript = buildGrammar {
    ...
    language = "typoscript";
    version = "0.0.0+rev=e59069a4cc08b2dacccd40827fe971ca3c6821b7";
    src = fetchFromGitHub {
      owner = "Teddytrombone";
  ...
  vim = buildGrammar {
    passthru.name = "vim";
    language = "vim";
    version = "0.0.0+rev=8b8db7d8e4db799ab6b0db25a7990c2890133c1e";
    src = fetchFromGitHub {
      owner = "tree-sitter-grammars";
  ...
  xresources = buildGrammar {
    ...
    language = "xresources";
    version = "0.0.0+rev=a19a2acc5299b9bc0e3b4c8184c2860fdc66eba0";
    src = fetchFromGitHub {
      owner = "ValdezFOmar";
